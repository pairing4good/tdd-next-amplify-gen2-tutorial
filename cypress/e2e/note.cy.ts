...
describe("Note Capture", () => {
  it("should create a note when name and description provided", () => {
    ...
    cy.get("[data-testid=note-name-field]", { timeout: 10000 }).should('exist').type("test note");
  ...
  it("should load previously saved notes on browser refresh", () => {
    cy.get("[data-testid=note-name-field]", { timeout: 10000 }).should('exist').type("test note 2");
